...
<div class="container mx-auto px-4 pt-16">
    <div class="popular-movies">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
            <div class="mt-8">
                <a href="#">
                    <img src="{{asset("img/dune2.webp")}}" alt="dune" class="hover:opacity-85 transition ease-in-out duration-75">
                </a>
                <div class="mt-2">
                    <a href="#" class="text-lg mt-2 hover:text-gray-300">Dune: Part II</a>
