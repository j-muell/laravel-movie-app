<div class="mt-8">
    <a href="{{ route('movies.show', $movie['id'])}}">
        <img src="{{'https://image.tmdb.org/t/p/w500'.$movie['poster_path']}}" alt="poster" class="hover:opacity-85 transition ease-in-out duration-75">
    </a>
    <div class="mt-2">
        <a href="{{ route('movies.show', $movie['id'])}}" class="text-lg mt-2 hover:text-secondary">{{ $movie['title']}}</a>
        <div class="flex items-center text-textSubHeading text-sm mt-1">
