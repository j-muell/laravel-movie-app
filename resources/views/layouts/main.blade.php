    ...
    <nav class="border-b border-gray-800">
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-6">
            ...
            <div class="flex flex-col md:flex-row items-center">
                <livewire:search-dropdown> <!-- This grabs the livewire component for the search found in search-dropdown.blade.php-->
                    <div class="md:ml-4 mt-3 md:mt-0">
                        <a href="#">
                            <img src="{{ asset('img/me-edited.jpg')}}" alt="Profile pic" class="rounded-full w-8 h-8">
                        </a>
                    </div>
            </div>
        </div>
    </nav>
    @yield('content') <!-- THIS WILL EXPORT THE FILE. Same as exporting in React. including in another file will give us the code above.-->
    <livewire:scripts>
</body>
